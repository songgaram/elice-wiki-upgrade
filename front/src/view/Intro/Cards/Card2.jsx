    ...
    return (
        <>
            <CardBox>
                ...
                <CardArticle>
                    IT 기술은 시시각각 변화하며, 개발자가 알아야하는 지식은 끝이 없습니다. 이러한
                    특성으로 개발자들은 구글링으로 학습을, 블로그로 기록과 공유를 해왔습니다.
                    <br />
                    <br />
                    그리고 기술이 사용되는 맥락에 따라 필요한 코드가 다르다는 특성으로 /*elice*/ 의
                    교육 콘텐츠는 핵심적이고 대표적인 내용 위주로 정리하여 전달하고 있습니다.
                    <br />
                    <br />
                    레이서들이 그냥 개발자가 아닌 실력있는 개발자로 성장하길 바라는 우리는
                    자기주도적이며 아는 것을 공유하는 학습공동체를 만들 방법을 고민했습니다.
                </CardArticle>
            </CardBox>
        </>
    );
